...
public class Main {
    public static void main(String[] args) {
        ...
        Map<Integer, Double> ortalamaFiyatlar = siparisler.stream()
                .collect(Collectors.groupingBy(s -> s.malNo,
                        Collectors.averagingDouble(s -> s.birimFiyat)));

        ortalamaFiyatlar.forEach((malNo, ortalamaFiyat) ->
                System.out.println("Mal No: " + malNo + ", Ortalama Fiyat: " + ortalamaFiyat));
    }
}
